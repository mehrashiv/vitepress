...
### can i create sites only initially?
    

No, when sites are created it is mandatory to create buildings as well.

### can i create floors. zones and upload floor plans later?
    

Yes, floors/zones can be created at a later date

### what service areas can be mapped to a wireless service?
...
### what service areas can be mapped to a dhcp/radius?
...
### my dhcp server serves multiple subnets for my site. can nile leverage this dhcp server?
    

Yes, Nile supports this deployment model

### can i create radius servers?
    

Yes, just like DHCP you can create multiple Radius servers at a Global level

### can i have separate radius servers for employee and guest?
...
### can i monitor the network based on service areas?
...
### can i remove the floor plan or change it?
